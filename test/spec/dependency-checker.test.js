    ...
    describe('DepStorage ->', function () {
        ...
        describe('multiple storages ->', function () {
            ...
            it('should inherit dependencies', function () {
                var storage2 = new SpeedShifter.Services.DepStorage(storage1), storage3 = new SpeedShifter.Services.DepStorage(storage2), storage4 = new SpeedShifter.Services.DepStorage(storage2, storage3);
            ...
            it('should inherit dependencies in correct order', function () {
                var storage2 = new SpeedShifter.Services.DepStorage(), storage3 = new SpeedShifter.Services.DepStorage(), storage4 = new SpeedShifter.Services.DepStorage(storage1, storage2, storage3), storage5 = new SpeedShifter.Services.DepStorage(storage2, storage3, storage1), storage6 = new SpeedShifter.Services.DepStorage(storage3, storage1, storage2), storage7 = new SpeedShifter.Services.DepStorage(storage3, storage2, storage1), storage8 = new SpeedShifter.Services.DepStorage(storage1, storage3, storage2);
                ...
                expect(storage4.getDepend('1').value).toEqual(3);
                ...
                expect(storage4.getDepend('2').value).toEqual(13);
                ...
                expect(storage4.getDepend('3').value).toEqual(13);
            ...
            it('setGlobals / getGlobals', function () {
                var storage2 = new SpeedShifter.Services.DepStorage(), storage3 = new SpeedShifter.Services.DepStorage(storage1);
